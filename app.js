...
var taskInput = document.querySelector(".add__task-new");//Add a new task.
var addButton = document.querySelector(".btn__add");//first button
var incompleteTaskHolder = document.querySelector(".todo__tasks__incomplete-list");//ul of #incompleteTasks
var completedTasksHolder = document.querySelector(".completed__tasks-list");//completed-tasks
...
var createNewTaskElement = function (taskString) {
  ...
  editInput.type = "text";
  editInput.className = "task add__task-text";
  ...
  deleteButtonImg.setAttribute("alt", "remove button image")
